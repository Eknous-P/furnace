...
#ifdef INCLUDE_BLEH_ROM
#ifndef BLEHROM
#define BLEHROM
static const unsigned char blehROM[1024] = {
...
#define CHANNOISEEN(c) CHANSTATE(c)>>7
#define CHANWAVEEN(c) (CHANSTATE(c)>>6)&1
#define CHANPMEN(c) (CHANSTATE(c)>>5)&1
